...
class OrderAggregate:
    ...
    def place_order(self, order):
        ...
        # 发布领域事件
        self.events.publish(OrderPlacedEvent(order))
```
...
event_manager.subscribe('user_created', UserObserver())
```
...
本章介绍了复杂项目架构设计。涵盖分层架构、微服务 vs 单体选择、DDD 概念、设计模式应用和架构决策文档。
